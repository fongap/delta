...
Delta 是一个本地优先的个人工作 AI Agent，专注于 **日常办公、数据分析和内容创作**。
...
- **数据分析**：从数据导入、清洗、统计设计、统计分析、可视化和结果解释，到完整分析 / 研究报告撰写的端到端工作。数据分析不是简单问数或画图，而是完整的数据统计分析与报告交付。
- **内容创作**：面向自媒体和个人内容生产的选题、资料研究、写作、编辑、配图 / 图文、多格式内容整理和发布准备。

PDF、Office 文件处理、Search、Citation、Validation、脚本、自动化和 Connector 等属于支撑上述三类工作的能力，不作为独立产品方向。
...
- **形成成果**：生成文档、表格、统计分析、图表、研究 / 分析报告、内容素材及其他 Artifact。
- **关键审批**：高后果操作进入统一 Policy / Approval 边界。
- **验证与追溯**：记录来源、执行事实、验证结果和任务恢复状态。

## 发展方向

Delta 将继续坚持本地优先，围绕三项核心能力重点完善：

- **日常办公体验**：文档、表格、PDF、资料整理和批量处理形成稳定闭环。
- **完整数据分析**：覆盖数据清洗、统计方法、统计计算、可视化、结果解释和正式报告撰写。
- **内容创作流程**：覆盖资料研究、写作、编辑、图文与多格式内容交付。
