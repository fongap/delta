...
def _validate_email(creds: dict) -> ValidationResult:
    from integrations.connectors.email_tools import validate_email_account
...
# entirely (see packaging/delta-server.spec). When the package is absent this is a no-op.
try:
