...
connector's actual tools (tool_defs.py) and the OAuth scopes the integration
declares. Overclaiming here is a product bug.
...
ABOUT: dict[str, str] = {
    "telegram": "Chat with your delta from Telegram. Messages to your bot "
    "reach the agent and replies come back to the same chat — only senders on "
    "your allow-list get through.",
    "slack": "Bring your delta into Slack: mention it in a channel or DM it, "
