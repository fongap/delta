...
# -- redirects: the address that actually loads -----------------------------------
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "http://127.0.0.1:8765/v1/health",  # Delta's own sidecar
...
def _open_url_with(monkeypatch, page):
    from integrations.connectors import browser_automation as ba
