...
surfaces (gateway session routes, REST paths), so a crafted id must never let a write
or read escape the conversations/ directory.

Semantic port of andrewyng/openworker e8824ab1f0197a90a1073f30a396b3037f0630b3.
"""
...
from core.conversations import ConversationStore, is_safe_session_id
...
def test_is_safe_session_id():
    ...
    for ok in (
        ...
        "__run__run-abcdef1234",  # automation run thread (core/automation/models.py)
