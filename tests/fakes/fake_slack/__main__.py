...
``delta-server`` and connecting Slack with any fake ``xoxb-``/``xapp-`` tokens.
"""
...
def main() -> None:
    ...
    print(
        "  # then start delta-server and connect Slack with any xoxb-/xapp- tokens"
    )
    print()
    ...
    print(
        ...
        '"message_ts":"1700000001.000001","action_id":"delta_0","value":"..."}\''
    )
    print(
