...
from providers import capabilities_for
from providers.base import AssistantTurn, ProviderClient, StreamChunk
from providers.vertex_provider import VertexProvider, load_credentials
...
def test_verify_vertex_api_key_method(monkeypatch):
    ...
    from providers.registry import verify_provider_key
...
def test_vertex_configured_needs_project_and_location():
    from providers.registry import descriptor_configured, get_descriptor
...
def _patch_verify(monkeypatch, creds: Any, status_code: int | None):
    ...
    import providers.vertex_provider as vp
