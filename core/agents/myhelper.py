...
Shares Delta's workspace toolset but has its own personality + prompt: a personal assistant
...
def myhelper_instructions(name: str = DEFAULT_HELPER_NAME) -> str:
    return (
        ...
        "big, self-contained jobs you may later hand off to a dedicated Delta session. Treat "
